...
public class BlastlingAnimations {
    public static final AnimationDefinition BLASTLING_WALK = AnimationDefinition.Builder.withLength(2f).looping()
            .addAnimation("head",
    ...
    public static final AnimationDefinition BLASTLING_IDLE = AnimationDefinition.Builder.withLength(2f).looping()
            .addAnimation("body",
                    new AnimationChannel(AnimationChannel.Targets.POSITION,
                            new Keyframe(0f, KeyframeAnimations.posVec(0f, 0f, 0f),
                                    AnimationChannel.Interpolations.LINEAR),
    ...
    public static final AnimationDefinition WATCHLING_ATTACK = AnimationDefinition.Builder.withLength(2f).looping()
            ...
            .addAnimation("r_leg",
                    new AnimationChannel(AnimationChannel.Targets.ROTATION,
                            ...
                            new Keyframe(2f, KeyframeAnimations.degreeVec(0f, 0f, 0f),
                                    AnimationChannel.Interpolations.LINEAR))).build();
    public static final AnimationDefinition BLASTLING_SHOOT = AnimationDefinition.Builder.withLength(2f).looping()
            .addAnimation("body",
                    new AnimationChannel(AnimationChannel.Targets.ROTATION,
                            new Keyframe(0f, KeyframeAnimations.degreeVec(0f, 0f, 0f),
                                    AnimationChannel.Interpolations.LINEAR),
